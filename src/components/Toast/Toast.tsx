...
import TickIcon from "./ToastIcons/TickIcon";
import CloseIcon from "./ToastIcons/CloseIcon";
import AlertIcon from "./ToastIcons/AlertIcon";

import "./ToastStyles/Toast.css";
